...
class RNA_DS(torch.utils.data.Dataset):
    ...
    def get_mats(self, r):
        ...
        bpp = np.triu(get_feature('bpps_linearfolde', r.sequence))
    ...
    def __getitem__(self, idx: int):
        ...
        ids = np.pad(ids,(1, self.len_max+1-len_seq), constant_values=-1)
        ...
        if mat is not None:
            return self.pad(out) | mat, {'ids': ids}
        else:
            return self.pad(out), {'ids': ids}
