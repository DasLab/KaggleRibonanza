...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        base_pair_probabilities = np.half(np.triu(get_feature('bpps_linearfolde', seq)))
        ...
        return {'input':torch.from_numpy(seq), 'input_mask':mask, 'bpp':base_pair_probabilities}, {'ids':ids} 
